...
4) The fluctuation between batches is quite small and usually much smaller than the fluctuation from sampling the variational determinants in the stochastic step.
This is a numerical phenomenon that we observed.
...
A batch contains all the determinants that satisfy $h \mod n = i$, where $i$ is the index of the batch and $n$ is the number of batches.
