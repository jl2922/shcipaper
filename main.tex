...
%Using up to $2\times10^9$ determinants and extrapolating the total energy, we estimate the FCI energy at equilibrium in this large active space to be $-2099.9224(6)$~Ha.
...
%The active space of this calculation is (28e, 76o), which is exceedingly large for FCI.
%By using SHCI with an unprecedented number of determinants and rigorous extrapolation, we achieve a significantly more accurate estimation of the FCI energy of this large active space to be 2099.9224(6) Ha.
...
\bibliography{main,hci,umrigar,toulouse,chan,needs,zhang,chemistry}
%\bibliography{hci}
