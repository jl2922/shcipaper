...
{\color{blue}
We skip the deterministic step here because $\epsilon_1=3.0\10^{-6}$ is already close to our default $\epsilon_2^{\rm dtm}$ of $\epsilon_1=2.0\10^{-6}$ so skipping this won't 
}
