...
double excitations.
For the same-spin excitations we use a method closely related
to that in Ref.~\cite{SceAppGinCaf-JCoC-16}.
The opposite-spin excitations are more computationally expensive
and our algorithm is designed to speed compute these efficiently.
...
In our Cr$_2$ calculation, we stochastically estimate the perturbative contribution from at least trillions of perturbative determinants, which is completely infeasible with a deterministic algorithm.
